...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XEQ");
    case mBTC: return QString("mXEQ");
    case uBTC: return QString::fromUtf8("μXEQ");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XEQs");
    case mBTC: return QString("Milli-XEQs (1 / 1,000)");
    case uBTC: return QString("Micro-XEQs (1 / 1,000,000)");
    default: return QString("???");
    }
}
