...
#include "ui_znumwnodeconfigdialog.h"

#include <QModelIndex>

ZnumwNodeConfigDialog::ZnumwNodeConfigDialog(QWidget *parent, QString nodeAddress, QString privkey) :
    QDialog(parent),
    ui(new Ui::ZnumwNodeConfigDialog)
{
    ui->setupUi(this);
...
ZnumwNodeConfigDialog::~ZnumwNodeConfigDialog()
{
    delete ui;
}
