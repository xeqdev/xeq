...
private slots:
    ...
    QString BuyXEQ(QString OrderType, double Quantity, double Rate);
    QString SellXEQ(QString OrderType, double Quantity, double Rate);
